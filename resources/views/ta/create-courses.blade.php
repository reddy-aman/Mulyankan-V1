<x-app-layout>
    ...
    <!-- Parent container: remove h-screen for a more flexible height -->
<div class="flex">
            ...
            @else
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    @foreach ($Course as $course)
                        <!-- Card with uniform margin (m-6) around it -->
                        <div
                        ...
                        >
                            ...
                            <p class="mb-3 font-normal text-gray-700">
                                ...
                                <br>
                                <!-- Stop the card click when "Read More" is clicked -->
                            ...
                            <a href="{{ route('assignments.index', ['id' => $course->id]) }}"
