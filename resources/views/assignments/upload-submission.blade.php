        ...
        <main class="flex-1 p-8 overflow-auto">
                            ...
                            <div class="flex space-x-4 overflow-x-auto pb-2">
                                @for ($p = 1; $p <= $part['end_page'] - $part['start_page'] + 1; $p++)
                                    <div class="flex-shrink-0 relative w-48 h-64 border rounded">
                                        <img src="{{ route('submissions.thumbnail', ['path' => urlencode($part['file_path']), 'page' => $p, 'size' => 'full']) }}"
            ...
            <div id="zoom-lightbox"
                ...
                <div class="absolute top-4 right-4 flex space-x-2 z-50">
                    ...
                    <button id="close-lightbox" class="text-white text-4xl font-bold hover:text-red-400"
