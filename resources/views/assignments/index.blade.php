        ...
        <div class="flex-1 flex flex-col p-6 bg-gray-50">
            ...
            <div class="flex-1 overflow-auto">
                ...
                <div class="mt-6 p-6 bg-white rounded-lg shadow">
                    ...
                    <a href="#" class="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 shadow">
                        + Create Assignment
                    </a>
                </div>
            ...
            <div class="bg-white shadow-md px-6 py-4 rounded-t-lg flex justify-end space-x-3">
                <a href="#" class="px-4 py-2 bg-white text-gray-800 border border-gray-300 rounded shadow-md hover:bg-gray-100">
                    Sync LMS Roster
                </a>
                <a href="#" class="px-4 py-2 bg-white text-gray-800 border border-gray-300 rounded shadow-md hover:bg-gray-100">
                    Download Roster
                ...
                <a href="#" class="px-4 py-2 bg-blue-600 text-white border border-blue-600 rounded shadow-md hover:bg-blue-700">
