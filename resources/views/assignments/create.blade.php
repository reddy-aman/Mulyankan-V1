    ...
    <div x-data="{
        ...
        <div class="flex items-center space-x-2 mb-8 text-sm">
            ...
            <div class="flex items-center cursor-pointer"
                :class="step === 1 ? 'font-semibold text-blue-600' : 'text-gray-500'" @click="step = 1">
                <span>1. Assignment Type</span>
            </div>
            <!-- Separator -->
            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" viewBox="0 0 24 24">
                <path d="M13 5l7 7-7 7" />
            </svg>
            <!-- Step 2 Indicator -->
            <div class="flex items-center cursor-pointer"
                :class="step === 2 ? 'font-semibold text-blue-600' : 'text-gray-500'" @click="step = 2">
        ...
        <div x-show="step === 1" x-transition class="bg-white rounded-lg shadow p-6">
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li class="relative">
                            <button
                                ...
                                :class="selectedType === 'exam' ? 'bg-blue-500 text-white' :
                                    'bg-gray-100 text-gray-700 hover:bg-gray-200'"
                                @click="selectedType = 'exam'" @mouseenter="showExamTooltip = true"
                                @mouseleave="showExamTooltip = false">
                                Exam / Quiz
                            </button>
                            <!-- Tooltip for Exam / Quiz -->
                            <div x-show="showExamTooltip" x-transition
                        ...
                        <li>
                            <button class="w-full text-left px-4 py-2 rounded transition-colors"
                                :class="selectedType === 'homework' ? 'bg-blue-500 text-white' :
                                    'bg-gray-100 text-gray-700 hover:bg-gray-200'"
                                @click="selectedType = 'homework'">
                                Homework / Problem Set<span class="ml-2 text-red-600 text-sm font-medium">WIP</span>
                            </button>
                        </li>
                        ...
                        <li>
                            <button class="w-full text-left px-4 py-2 rounded transition-colors"
                                :class="selectedType === 'bubble' ? 'bg-blue-500 text-white' :
                                    'bg-gray-100 text-gray-700 hover:bg-gray-200'"
                                @click="selectedType = 'bubble'">
                                Bubble Sheet<span class="ml-2 text-red-600 text-sm font-medium">WIP</span>
                            </button>
                        </li>
                        ...
                        <li>
                            <button class="w-full text-left px-4 py-2 rounded transition-colors"
                                :class="selectedType === 'programming' ? 'bg-blue-500 text-white' :
                                    'bg-gray-100 text-gray-700 hover:bg-gray-200'"
                                @click="selectedType = 'programming'">
                                Programming Assignment<span class="ml-2 text-red-600 text-sm font-medium">WIP</span>
                            </button>
                        </li>
                        ...
                        <li>
                            <button class="w-full text-left px-4 py-2 rounded transition-colors"
                                :class="selectedType === 'online' ? 'bg-blue-500 text-white' :
                                    'bg-gray-100 text-gray-700 hover:bg-gray-200'"
                                @click="selectedType = 'online'">
                                Online Assignment<span class="ml-2 text-red-600 text-sm font-medium">WIP</span>
                            </button>
                        </li>
                    </ul>
                </nav>
            ...
            <div class="flex justify-end mt-6">
                <button type="button" @click="window.location.href = routes[selectedType]"
