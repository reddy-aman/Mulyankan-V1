                    ...
                    @else
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            @foreach ($Course as $course)
                                <div onclick="window.location='{{ route('courses_student.show', ['id' => $course->id]) }}';"
                                    class="cursor-pointer w-full p-4 sm:p-6 bg-white border border-gray-200 
                                           rounded-lg shadow hover:bg-gray-100 m-6">
                                    <!-- Term + Year -->
                                    <p
                                        class="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-2 rounded border border-blue-400">
                                    ...
                                    <p class="mb-3 font-normal text-gray-700">
                                        ...
                                        <a href="javascript:void(0);" data-modal-target="default-modal"
                                            data-modal-toggle="default-modal" class="read-more text-blue-500"
