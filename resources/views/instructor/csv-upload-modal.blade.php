<div x-show="showCSVUpload" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50" @click="showCSVUpload = false">
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-lg w-full" @click.stop>
        ...
        <form id="csvUploadForm" class="mt-4">
            ...
            <p class="mt-4 text-lg font-semibold text-red-600 bg-red-100 p-3 rounded-lg border border-red-400">
                ⚠ CSV Format: <strong>Name, Email, Student ID, Role</strong> (Role must be <em>Student, Instructor, or TA</em>)
            </p>
