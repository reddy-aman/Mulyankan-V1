<div x-show="showSingleUser" x-cloak class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50" @click="showSingleUser = false">
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-lg w-full" @click.stop>
        ...
        <form id="addUserForm" class="mt-4">
            ...
            <input type="text" name="name" id="name" placeholder="e.g. Johnny Smith" class="border px-4 py-2 w-full rounded" required>
            
            <label class="block text-sm font-medium text-gray-700 mt-4 mb-1">Email Address <span class="text-red-500">*</span></label>
            <input type="email" name="email" id="email" placeholder="e.g. email@example.com" class="border px-4 py-2 w-full rounded" required>
            
            <label class="block text-sm font-medium text-gray-700 mt-4 mb-1">Student ID # (Optional)</label>
            <input type="text" name="sid" id="sid" placeholder="e.g. 12345" class="border px-4 py-2 w-full rounded">
            ...
            <div class="mt-6 flex justify-end space-x-2">
                <button type="button" class="px-4 py-2 bg-gray-200 border rounded hover:bg-gray-300" @click="showSingleUser = false">
                    Cancel
                </button>
